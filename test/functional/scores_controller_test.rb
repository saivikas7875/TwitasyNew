...
class ScoresControllerTest < ActionController::TestCase
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post :create, score: { hashtagscore: @score.hashtagscore, totalscore: @score.totalscore, tweetscore: @score.tweetscore }
    end
  ...
  test "should update score" do
    put :update, id: @score, score: { hashtagscore: @score.hashtagscore, totalscore: @score.totalscore, tweetscore: @score.tweetscore }
    assert_redirected_to score_path(assigns(:score))
  end
